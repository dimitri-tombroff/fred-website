...
Brontë relies on a synergy of orchestration, toolkits, and MCP integration:
...
flowchart TD
    ...
    subgraph KnowledgeFlow["📚 Knowledge Flow Backend"]
        note1["Handles resource management (prompts & templates)"]
        ...
        %% MCP endpoints exposed to Brontë
    ...
    MCP -->|MCP API Communication| Controller

    %% Styles
    style UI fill:#d0e1ff,stroke:#333,stroke-width:1.5px
    style AgenticBackend fill:#ffe5cc,stroke:#333,stroke-width:1.5px
    style KnowledgeFlow fill:#e2ffe2,stroke:#333,stroke-width:1.5px
    style Store fill:#f8f8f8,stroke:#888,stroke-dasharray: 5,5
    ...
    style note1 fill:#d9ffd9,stroke:#3a3,stroke-width:1px,font-style:italic
{{< /mermaiddiagram >}}
...
3. The **Content Generator Toolkit** provides MCP-bound tools for resource management.  
4. The **MCP Client** connects Brontë to the Knowledge Flow Backend.  
5. The **ResourceController** validates and processes the request with the **ResourceService**.  
